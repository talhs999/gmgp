        ...
        <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-4">
              <input type="url" name="imageUrl" value={form.imageUrl} onChange={handleChange} className="flex-1 border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-black rounded-lg" placeholder="https://images.unsplash.com/..." />
