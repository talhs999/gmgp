...
export default function MainSlider() {
  ...
  return (
    ...
    >
      ...
      {/* ============================================================ */}
      <div className="relative flex items-center bg-white px-5 sm:px-10 py-3 shadow-inner">
        {/* Join Membership */}
        <a
          href="/membership"
          className="flex items-center gap-2 bg-[#E31B23] text-white text-xs sm:text-sm font-bold px-5 py-2.5 rounded-full hover:bg-[#c01019] transition-colors shadow"
        >
        ...
        {/* Pagination dots — centred absolutely */}
